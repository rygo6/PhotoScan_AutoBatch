...
def photoscanProcess(root_path, project_name):
    ...
    chunk.matchPhotos(accuracy=PhotoScan.LowAccuracy, preselection=PhotoScan.ReferencePreselection, filter_mask=False,
                      keypoint_limit=0, tiepoint_limit=0)
    chunk.alignCameras()
...
photoscanProcess(folder, "result")
